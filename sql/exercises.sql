-- ===================================================================
-- ANSI SQL Using MySQL — Local Community Event Portal
-- Schema, Sample Data, and 25 Exercises
-- ===================================================================
...
('Fiona Green', 'fiona@example.com', 'Chicago', '2025-03-10'),
('George Brown', 'george@example.com', 'New York', '2025-03-20');
...
('Music Festival', 'Local bands and artists performing live.', 'New York', '2025-08-20 14:00:00', '2025-08-20 22:00:00', 'upcoming', 1),
('Art Workshop', 'Watercolor and acrylic painting session.', 'Chicago', '2025-04-10 10:00:00', '2025-04-10 14:00:00', 'completed', 3);
...
(3, 'CSS3 Layouts', 'Bob Smith', '2025-07-01 13:00:00', '2025-07-01 15:00:00'),
(3, 'JavaScript Basics', 'Diana King', '2025-07-02 10:00:00', '2025-07-02 12:00:00'),
(5, 'Painting Techniques', 'Fiona Green', '2025-04-10 10:00:00', '2025-04-10 11:30:00');
...
(1, 2, 5, 'Excellent conference!', '2025-05-17'),
(6, 3, 2, 'Too basic for me.', '2025-07-04');
...
-- Identify events with the highest average rating, considering only
-- those that have received at least 10 feedback submissions.
-- -------------------------------------------------------------------
...
-- List all users who gave feedback with a rating less than 3, along with
-- their comments and associated event names.
-- -------------------------------------------------------------------
...
-- For each event organizer, show the number of events created and their
-- current status (upcoming, completed, cancelled).
-- -------------------------------------------------------------------
...
-- -------------------------------------------------------------------
SELECT e.event_id, e.title, COUNT(DISTINCT r.user_id) AS registered_users
FROM Events e
JOIN Registrations r ON e.event_id = r.event_id
...
-- Identify overlapping sessions within the same event (i.e., session
-- start and end times that conflict).
-- -------------------------------------------------------------------
SELECT s1.event_id, e.title,
    s1.title AS session1, s1.start_time, s1.end_time,
    s2.title AS session2, s2.start_time, s2.end_time
FROM Sessions s1
...
-- Find users who created an account in the last 30 days but haven't
...
-- -------------------------------------------------------------------
SELECT u.user_id, u.full_name, u.email, COUNT(f.feedback_id) AS feedback_count
FROM Users u
